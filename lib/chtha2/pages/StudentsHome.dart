...
import 'package:edu_flex/chtha2/constants/firestore_constants.dart';
import 'package:edu_flex/chtha2/models/popup_choices.dart';
import 'package:edu_flex/chtha2/models/user_chat.dart';
import 'package:edu_flex/chtha2/pages/chat_page.dart';


import 'package:edu_flex/chtha2/pages/settings_page.dart';
import 'package:edu_flex/chtha2/pages/student_login.dart';
import 'package:edu_flex/chtha2/providers/providers.dart';
import 'package:edu_flex/chtha2/utils/debouncer.dart';
import 'package:edu_flex/chtha2/utils/utilities.dart';
...
class StudentsHome extends StatefulWidget {
  ...
  @override
  State createState() => StudentsHomeState();
}

class StudentsHomeState extends State<StudentsHome> {
  StudentsHomeState({Key key});
  ...
  void showNotification(RemoteNotification remoteNotification) async {
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      Platform.isAndroid ? 'com.example.edu_flex' : 'com.example.eduFlex',
      'edu_flex',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Chat App',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
        centerTitle: true,
