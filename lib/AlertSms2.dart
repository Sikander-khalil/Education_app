...
class AlertSms2 extends StatefulWidget {
  const AlertSms2({Key key}) : super(key: key);

  @override
  State<AlertSms2> createState() => _AlertSms2State();
}

class _AlertSms2State extends State<AlertSms2> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('SMS through phone'),
        ...
        body: ListView(
          children: <Widget>[
            ...
            SizedBox(height: 40,),
            Center(child: Text('Welcome to SMS',style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold),)),
            SizedBox(height: 100,),
            ListTile(
